...
// (Javascript/CoffeeScript) or hash (ruby) passed in and
// generates a human readable string from its key/value pairs.
// The format should be "KEY = VALUE". Each key/value pair should
// be seperated by a comma except for the last pair
// Example:
